...
def check_certificate(url):
    ...
    Args:
        url (str): Domain to check
        
    Returns:
        tuple: (status, expiry_date, issuer)
    """
    try:
...
def check_url_mt(domains, username):
    """
    Check multiple domains using multithreading
    ...
    def check_url():
        """Worker function to check a single domain"""
